...
用法：
    python3 scripts/fmt_split_dialogues.py chapter_md/002_夏本纪.md [输出文件]
"""
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print("用法: python3 scripts/fmt_split_dialogues.py <markdown文件> [输出文件]")
        print("示例: python3 scripts/fmt_split_dialogues.py chapter_md/002_夏本纪.md")
        sys.exit(1)
